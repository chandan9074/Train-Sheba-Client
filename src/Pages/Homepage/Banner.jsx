            ...
            <div className="container flex justify-between">
                ...
                <div className="bg-gray-800 bg-opacity-70 py-4 px-5 rounded-md">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex items-end">
                            <div className="flex flex-col">
                                ...
                                <p className="m-0 border-b-2 border-red-700">
                                    ...
                                    <select  type="text" className="bg-transparent w-48 appearance-none py-1 px-2 outline-none text-gray-300 " {...register("from")} placeholder="From">
                            ...
                            <div  className="flex flex-col">
                                ...
                                <p className="m-0 border-b-2 border-red-700">
                                    ...
                                    <select  type="text" className="bg-transparent w-48 appearance-none py-1 px-2 outline-none text-gray-300 " {...register("to")} placeholder="to">
                                        <option value="Chittagong">Chittagong</option>
                                        <option value="dhaka">Dhaka</option>
                                        <option value="Barisal">Barisal</option>
                                        <option value="Khulna">Khulna</option>
                        ...
                        <div className="flex items-center mt-3 justify-between">
                            <div  className="flex flex-col">
                                ...
                                <p className="m-0 border-b-2 border-red-700">
                                    ...
                                    <input type="text" className="bg-transparent w-48 py-1 px-2 outline-none text-gray-300 " {...register("departure")} placeholder="MM/DD/YY" />
                            ...
                            <div  className="flex flex-col">
                                ...
                                <p className="m-0 border-b-2 border-red-700">
                                    ...
                                    <input type="text" className="bg-transparent w-48 py-1 px-2 outline-none text-gray-300 " {...register("return")} placeholder="MM/DD/YY" />
                                    <i class="fas fa-calendar-alt text-gray-400 mr-2"></i>
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center mt-3 justify-between">
                            <div   className="flex flex-col">
                                ...
                                <p className="m-0 border-b-2 border-red-700">
                                    ...
                                    <input type="text" className="bg-transparent w-48 py-1 px-2 outline-none text-gray-300 " {...register("passengers")} placeholder="2 ADUILT + 1 CHILD" />
                            ...
                            <div  className="flex flex-col">
                                ...
                                <p className="m-0 border-b-2 border-red-700">
                                    ...
                                    <select type="text" className="bg-transparent appearance-none w-48 py-1 px-2 outline-none text-gray-300 " {...register("class")} placeholder="class" >
                        ...
                        <button className="nice mx-auto mt-5">
                            <span><a href="/"></a></span>
                        </button>
                    </form>
                </div>
